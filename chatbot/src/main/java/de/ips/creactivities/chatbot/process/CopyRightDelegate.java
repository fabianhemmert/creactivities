...
@Component
public class CopyRightDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        String text = getCopyRight(languageCode);
        String imageUrl = cmsService.getRightsOfUseImage(languageCode);
        ...
        InlineKeyboardMarkup keyboard = InlineKeyboardMarkup.builder().keyboardRow(List.of(
                        InlineKeyboardButton.builder()
                                ...
                                .callbackData(processInstanceId + "_" + IMessageEvents.COPY_RIGHT_ACCEPTED).build()))
                .build();
    ...
    private String getCopyRight(String languageCode) {
        return cmsService.getRightsOfUse(languageCode);
    }
