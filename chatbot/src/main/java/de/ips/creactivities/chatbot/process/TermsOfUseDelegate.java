...
@Component
public class TermsOfUseDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        String text = getTermsOfService(languageCode);
        String imageUrl = cmsService.getTermsOfServiceImage(languageCode);
        ...
        InlineKeyboardMarkup keyboard = InlineKeyboardMarkup.builder().keyboardRow(List.of(
                        InlineKeyboardButton.builder()
                                ...
                                .callbackData(processInstanceId + "_" + IMessageEvents.TERMS_OF_USE_ACCEPTED).build()))
                .build();
    ...
    private String getTermsOfService(String languageCode) {
        return cmsService.getTermsOfService(languageCode);
    }
